...
.PHONY: build build-all test test-v test-report wiki-sync lint install clean help
...
## wiki-sync: Push docs/WIKI.md to the configured wiki repos (mattlab.at, optionally GitHub)
wiki-sync:
